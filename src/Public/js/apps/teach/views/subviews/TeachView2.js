define(function(require) {
	...
	var TeachView2 = Backbone.View.extend({
		template: require('hbs!./../../templates/TeachView2'),
		...
		render: function () {
			...
			var values1 = [[1,2,0,6,3,6,2,6], [2,1,3,2,7,2,7,4], [5,8,1,1,0,9,4,9], [6,4,6,8,3,1,6,1], [5,6,2,1,7,6,2,1], [7,6,1,1,1,6,3,4]];
			var $matr1 = MatrixBuilder.create(values1, 6, 8);
			this.$("#matrix1").append($matr1);

			MatrixBuilder.highlightCell($matr1, 0, 0);
			MatrixBuilder.highlightCell($matr1, 1, 0);
			MatrixBuilder.highlightCell($matr1, 1, 1);
			MatrixBuilder.highlightCell($matr1, 1, 2);
			MatrixBuilder.highlightCell($matr1, 2, 2);
			MatrixBuilder.highlightCell($matr1, 2, 3);
			MatrixBuilder.highlightCell($matr1, 3, 3);
			MatrixBuilder.highlightCell($matr1, 3, 4);
			MatrixBuilder.highlightCell($matr1, 3, 5);
			MatrixBuilder.highlightCell($matr1, 4, 5);
			MatrixBuilder.highlightCell($matr1, 4, 6);
			MatrixBuilder.highlightCell($matr1, 5, 6);
			MatrixBuilder.highlightCell($matr1, 5, 7);
